...
puppet apply --modulepath=/home/osboxes/.puppet/modules:/usr/share/puppet/modules:/etc/puppet/environments/production/modules /etc/puppet/environments/production/manifests/site.pp
